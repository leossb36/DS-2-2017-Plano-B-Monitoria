...
class OrcamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orcamento" do
    assert_difference('Orcamento.count') do
      post orcamentos_url, params: { orcamento: { cidade: @orcamento.cidade, contratado: @orcamento.contratado, orcamentoId_id: @orcamento.orcamentoId_id, preco: @orcamento.preco } }
    end
  ...
  test "should update orcamento" do
    patch orcamento_url(@orcamento), params: { orcamento: { cidade: @orcamento.cidade, contratado: @orcamento.contratado, orcamentoId_id: @orcamento.orcamentoId_id, preco: @orcamento.preco } }
